...
export class NgxMaterialTimepickerComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    this.subscriptions.push(this.timepickerService.selectedSecond.subscribe(second => this.selectedSecond = second));
  ...
  setDefaultTime(timeObj) {
    this.timepickerService.defaultTime = timeObj;
  }
